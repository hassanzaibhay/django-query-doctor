...
create_terminal_svg(
    ...
    lines=[
        ...
        {"text": "  [N+1 detected: 12 queries for table \"myapp_author\" (field: author)] [MANUAL FIX ONLY]", "color": "#DCDCAA"},
        ...
        {"text": "  [Missing index: column \"published_date\" on Book (table \"myapp_book\") is used in WHERE/ORDER BY but has no index]", "color": "#DCDCAA"},
        {"text": "-     recent = Book.objects.filter(published_date__gte=cutoff)", "color": "#F44747"},
        {"text": "+     # TODO: Consider adding an index via Meta.indexes - Add db_index=True to the 'published_date' field", "color": "#28CA41"},
