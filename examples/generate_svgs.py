...
create_terminal_svg(
    ...
    lines=[
        ...
        {"text": "Location: myapp/views.py:27 in book_list", "color": "#808080", "indent": 3},
        {"text": "Fix: Add to Book's Meta.indexes: indexes = [models.Index(fields=[\"title\"])]", "color": "#4EC9B0", "indent": 3},
        {"text": ""},
...
create_terminal_svg(
    ...
    lines=[
        ...
        {"text": "+     # TODO: Consider adding an index via Meta.indexes - Add to Book's Meta.indexes: indexes = [models.Index(fields=[\"published_date\"])]", "color": "#28CA41"},
